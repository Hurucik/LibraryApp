...
namespace LibraryApp {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(int TicketId, string UserName) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public int TicketId {
                get {
                    return ((int)(this[this.tableUser.TicketIdColumn]));
                }
                set {
                    this[this.tableUser.TicketIdColumn] = value;
                }
            }
...
namespace LibraryApp.LibraryDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([UserId] = @Original_UserId) AND ([TicketId] = @" +
                "Original_TicketId) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([TicketId], [UserName]) VALUES (@TicketId, @UserName);\r" +
                "\nSELECT UserId, TicketId, UserName FROM [User] WHERE (UserId = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [TicketId] = @TicketId, [UserName] = @UserName WHERE (([UserId] = @Original_UserId) AND ([TicketId] = @Original_TicketId) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)));
SELECT UserId, TicketId, UserName FROM [User] WHERE (UserId = @UserId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, TicketId, UserName FROM dbo.[User]";
        ...
        public virtual int Delete(int Original_UserId, int Original_TicketId, string Original_UserName) {
        ...
        public virtual int Insert(int TicketId, string UserName) {
        ...
        public virtual int Update(int TicketId, string UserName, int Original_UserId, int Original_TicketId, string Original_UserName, int UserId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int TicketId, string UserName, int Original_UserId, int Original_TicketId, string Original_UserName) {
            return this.Update(TicketId, UserName, Original_UserId, Original_TicketId, Original_UserName, Original_UserId);
        }
    }
